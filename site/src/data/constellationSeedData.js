...
export const SCHOOL_COLORS = {
  ...
  // ADDITIONAL SCHOOLS (v2.3)
  'Cynic': '#7A8B5C',
  'Psychoanalysis': '#9966AA',
  'Physics/Scientist': '#3399BB',
  'Historian': '#8B7355',
  'Neo-Confucian': '#B8860B',
  'Reform Hinduism': '#CD7F32',
  'Integral Yoga': '#8B668B',
  'Feminist': '#CC6699',
  'Psychology': '#AA7799',
  'Pacifist': '#6699AA',
  'Anti-Totalitarian': '#556677',
  'Logotherapy': '#7788AA',
  'Education': '#66AA88',
};
...
export const SCHOOL_STANCES = {
  ...
  'Church Fathers': 'anti',
  // ADDITIONAL SCHOOLS (v2.3)
  'Cynic': 'anti',         // Rejected conventional values; asceticism
  'Psychoanalysis': 'anti', // Unconscious drives; anti-reason in foundations
  'Physics/Scientist': 'pro', // Scientific method; empirical reality
  'Historian': 'pro',       // Historical facts; objectivity
  'Neo-Confucian': 'pro',   // Rational ethics; metaphysical order
  'Reform Hinduism': 'anti', // Religious reform but still mystical
  'Integral Yoga': 'anti',  // Spiritual evolution; mystical
  'Feminist': 'anti',       // Collectivist; anti-reason in radical forms
  'Psychology': 'pro',      // Scientific psychology; empirical
  'Pacifist': 'anti',       // Absolute non-violence can be anti-rational
  'Anti-Totalitarian': 'pro', // Defends individual rights against tyranny
  'Logotherapy': 'pro',     // Meaning through reason and will
  'Education': 'pro',       // Child development; empirical methods
};
...
export const SEED_NODES = [
  ...
  // ═══════════════════════════════════════════════════════════
  // ADDITIONAL PHILOSOPHERS (v2.3) - 35 philosophers synced from backend
  // ═══════════════════════════════════════════════════════════
  ...
  // ANCIENT GREEK (3)
  {
    ...
    latitude: 42.0264,
    longitude: 35.1511,
    school_of_thought: 'Cynicism',
    school: 'Cynic',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Rejection of material possessions; live according to nature; virtue through ascetic practice'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.4, reality_mysticism: 0.3, individual_collective: 0.8, freedom_coercion: 0.9, value_nihilism: -0.2, market_planning: 0.2, beauty_chaos: -0.4, good_evil: 0.3 }
  },
  {
    id: 'hypatia',
    name: 'Hypatia',
    ...
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Mathematics and astronomy; rational inquiry; preservation of classical knowledge'],
    historical_weight: 0.7,
    battles: { reason_faith: 0.8, reality_mysticism: 0.4, individual_collective: 0.5, freedom_coercion: 0.6, value_nihilism: 0.6, market_planning: 0.0, beauty_chaos: 0.7, good_evil: 0.5 }
  },
  {
    id: 'thucydides',
    name: 'Thucydides',
    ...
    latitude: 37.9838,
    longitude: 23.7275,
    school_of_thought: 'Historical Realism',
    school: 'Historian',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['History as rigorous inquiry; power politics; Melian dialogue on might vs. right'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.8, reality_mysticism: 0.9, individual_collective: 0.3, freedom_coercion: 0.4, value_nihilism: 0.4, market_planning: 0.0, beauty_chaos: 0.5, good_evil: 0.3 }
  },
  {
    id: 'plutarch',
    name: 'Plutarch',
    ...
    death_year: 119,
    dates: 'c.46–119 AD',
    birth_city: 'Chaeronea',
    birth_country_modern: 'Greece',
    latitude: 38.4972,
    longitude: 22.8436,
    school_of_thought: 'Middle Platonism',
    school: 'Platonic',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Parallel Lives; moral biography; virtue through example; character shapes destiny'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.6, reality_mysticism: 0.5, individual_collective: 0.4, freedom_coercion: 0.5, value_nihilism: 0.7, market_planning: 0.0, beauty_chaos: 0.6, good_evil: 0.7 }
  },
  ...
  // MEDIEVAL / RENAISSANCE (2)
  {
    ...
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Divine visions; holistic medicine; sacred music; cosmic harmony'],
    historical_weight: 0.7,
    battles: { reason_faith: -0.6, reality_mysticism: -0.8, individual_collective: 0.2, freedom_coercion: 0.3, value_nihilism: 0.7, market_planning: 0.0, beauty_chaos: 0.9, good_evil: 0.8 }
  },
  {
    ...
    latitude: 43.7833,
    longitude: 10.9333,
    school_of_thought: 'Renaissance Polymath',
    school: 'Humanist',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Observation as source of knowledge; art and science unified; anatomy; engineering'],
    historical_weight: 1.0,
    battles: { reason_faith: 0.8, reality_mysticism: 0.9, individual_collective: 0.7, freedom_coercion: 0.6, value_nihilism: 0.8, market_planning: 0.3, beauty_chaos: 0.95, good_evil: 0.6 }
  },
  ...
  // EARLY MODERN (3)
  {
    ...
    latitude: 43.7228,
    longitude: 10.4017,
    school_of_thought: 'Scientific Revolution',
    school: 'Physics/Scientist',
    tradition: 'western',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Heliocentrism; experimental method; mathematics as language of nature; telescopic observations'],
    historical_weight: 1.0,
    battles: { reason_faith: 0.95, reality_mysticism: 0.95, individual_collective: 0.6, freedom_coercion: 0.7, value_nihilism: 0.7, market_planning: 0.0, beauty_chaos: 0.8, good_evil: 0.5 }
  },
  {
    id: 'chanakya',
    name: 'Chanakya',
    ...
    dates: 'c.375–283 BC',
    birth_city: 'Taxila',
    birth_country_modern: 'Pakistan',
    latitude: 33.7463,
    longitude: 72.7917,
    school_of_thought: 'Political Philosophy / Arthashastra',
    school: 'Political Realist',
    tradition: 'indian',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Arthashastra; realpolitik; statecraft; ends justify means in governance'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.7, reality_mysticism: 0.8, individual_collective: -0.2, freedom_coercion: -0.3, value_nihilism: 0.4, market_planning: -0.2, beauty_chaos: 0.3, good_evil: 0.2 }
  },
  {
    id: 'basava',
    name: 'Basava',
    ...
    latitude: 16.5833,
    longitude: 75.5833,
    school_of_thought: 'Lingayatism / Social Reform',
    school: 'Reform Hinduism',
    tradition: 'indian',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Anti-caste movement; devotional equality; rejection of ritual; social justice'],
    historical_weight: 0.6,
    battles: { reason_faith: -0.3, reality_mysticism: -0.4, individual_collective: -0.2, freedom_coercion: 0.5, value_nihilism: 0.6, market_planning: -0.2, beauty_chaos: 0.5, good_evil: 0.7 }
  },
  ...
  // NEO-CONFUCIAN (2)
  {
    ...
    latitude: 26.1700,
    longitude: 118.0000,
    school_of_thought: 'Neo-Confucianism',
    school: 'Neo-Confucian',
    tradition: 'chinese',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Li (principle) and qi (vital force); investigation of things; moral cultivation'],
    historical_weight: 0.9,
    battles: { reason_faith: 0.7, reality_mysticism: 0.6, individual_collective: -0.3, freedom_coercion: 0.2, value_nihilism: 0.8, market_planning: -0.2, beauty_chaos: 0.6, good_evil: 0.8 }
  },
  {
    id: 'wang_yangming',
    name: 'Wang Yangming',
    ...
    latitude: 30.0333,
    longitude: 121.1500,
    school_of_thought: 'Neo-Confucianism (Idealist)',
    school: 'Neo-Confucian',
    tradition: 'chinese',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Unity of knowledge and action; innate moral knowledge; heart-mind as source of truth'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.5, reality_mysticism: 0.3, individual_collective: 0.2, freedom_coercion: 0.4, value_nihilism: 0.7, market_planning: -0.1, beauty_chaos: 0.5, good_evil: 0.8 }
  },
  ...
  // MODERN INDIAN (2)
  {
    ...
    death_year: 1833,
    dates: '1772–1833',
    birth_city: 'Radhanagar',
    birth_country_modern: 'India',
    latitude: 23.2500,
    longitude: 87.9500,
    school_of_thought: 'Hindu Reform / Rationalism',
    school: 'Reform Hinduism',
    tradition: 'indian',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Abolition of sati; monotheism; education reform; synthesis of East and West'],
    historical_weight: 0.75,
    battles: { reason_faith: 0.6, reality_mysticism: 0.3, individual_collective: 0.4, freedom_coercion: 0.7, value_nihilism: 0.6, market_planning: 0.2, beauty_chaos: 0.4, good_evil: 0.7 }
  },
  {
    id: 'sri_aurobindo',
    name: 'Sri Aurobindo',
    ...
    latitude: 22.5726,
    longitude: 88.3639,
    school_of_thought: 'Integral Yoga',
    school: 'Integral Yoga',
    tradition: 'indian',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Spiritual evolution; supramental consciousness; integral yoga; divine life on earth'],
    historical_weight: 0.7,
    battles: { reason_faith: -0.3, reality_mysticism: -0.7, individual_collective: 0.3, freedom_coercion: 0.5, value_nihilism: 0.6, market_planning: 0.0, beauty_chaos: 0.7, good_evil: 0.6 }
  },

  // ENLIGHTENMENT & AMERICAN FOUNDERS (3)
  {
    ...
    latitude: 42.3601,
    longitude: -71.0589,
    school_of_thought: 'Enlightenment / Pragmatism',
    school: 'Enlightenment',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Self-improvement; practical virtue; scientific inquiry; American independence'],
    historical_weight: 0.9,
    battles: { reason_faith: 0.7, reality_mysticism: 0.8, individual_collective: 0.6, freedom_coercion: 0.8, value_nihilism: 0.7, market_planning: 0.5, beauty_chaos: 0.5, good_evil: 0.6 }
  },
  {
    ...
    death_year: 1804,
    dates: '1755–1804',
    birth_city: 'Charlestown',
    birth_country_modern: 'Saint Kitts and Nevis',
    latitude: 17.1333,
    longitude: -62.6167,
    school_of_thought: 'Federalism / Classical Liberalism',
    school: 'Liberal',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Strong federal government; national bank; manufacturing economy; constitutional interpretation'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.7, reality_mysticism: 0.8, individual_collective: 0.3, freedom_coercion: 0.6, value_nihilism: 0.6, market_planning: 0.2, beauty_chaos: 0.4, good_evil: 0.5 }
  },
  {
    id: 'frederic_passy',
    name: 'Frederic Passy',
    ...
    latitude: 48.8566,
    longitude: 2.3522,
    school_of_thought: 'Classical Liberalism / Pacifism',
    school: 'Pacifist',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Peace through free trade; international arbitration; first Nobel Peace Prize'],
    historical_weight: 0.6,
    battles: { reason_faith: 0.6, reality_mysticism: 0.7, individual_collective: 0.5, freedom_coercion: 0.7, value_nihilism: 0.6, market_planning: 0.5, beauty_chaos: 0.4, good_evil: 0.7 }
  },

  // 19TH-20TH CENTURY CONTINENTAL (6)
  {
    id: 'sigmund_freud',
    name: 'Sigmund Freud',
    birth_year: 1856,
    ...
    latitude: 49.5833,
    longitude: 18.1500,
    school_of_thought: 'Psychoanalysis',
    school: 'Psychoanalysis',
    tradition: 'western',
    stance: 'anti',
    is_champion: true,
    key_ideas: ['Unconscious mind; id-ego-superego; repression; Oedipus complex; dream interpretation'],
    historical_weight: 1.0,
    battles: { reason_faith: 0.4, reality_mysticism: 0.5, individual_collective: 0.5, freedom_coercion: 0.3, value_nihilism: 0.3, market_planning: 0.0, beauty_chaos: 0.5, good_evil: 0.2 }
  },
  {
    id: 'carl_jung',
    name: 'Carl Jung',
    ...
    latitude: 47.5833,
    longitude: 9.3167,
    school_of_thought: 'Analytical Psychology',
    school: 'Psychology',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Collective unconscious; archetypes; individuation; synchronicity; psychological types'],
    historical_weight: 0.9,
    battles: { reason_faith: 0.3, reality_mysticism: -0.2, individual_collective: 0.4, freedom_coercion: 0.5, value_nihilism: 0.5, market_planning: 0.0, beauty_chaos: 0.6, good_evil: 0.4 }
  },
  {
    ...
    latitude: 40.4168,
    longitude: -3.7038,
    school_of_thought: 'Perspectivism / Vitalism',
    school: 'Vitalist',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Revolt of the masses; perspectivism; I am I and my circumstances; vital reason'],
    historical_weight: 0.75,
    battles: { reason_faith: 0.5, reality_mysticism: 0.4, individual_collective: 0.6, freedom_coercion: 0.6, value_nihilism: 0.5, market_planning: 0.3, beauty_chaos: 0.6, good_evil: 0.4 }
  },
  {
    id: 'benedetto_croce',
    ...
    death_year: 1952,
    dates: '1866–1952',
    birth_city: 'Pescasseroli',
    birth_country_modern: 'Italy',
    latitude: 41.8089,
    longitude: 13.7892,
    school_of_thought: 'Idealism / Historicism',
    school: 'German Idealism',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Absolute historicism; aesthetics as intuition; philosophy as methodology of history'],
    historical_weight: 0.7,
    battles: { reason_faith: 0.5, reality_mysticism: 0.3, individual_collective: 0.4, freedom_coercion: 0.6, value_nihilism: 0.5, market_planning: 0.2, beauty_chaos: 0.7, good_evil: 0.4 }
  },
  {
    id: 'jacques_lacan',
    name: 'Jacques Lacan',
    ...
    latitude: 48.8566,
    longitude: 2.3522,
    school_of_thought: 'Structural Psychoanalysis',
    school: 'Psychoanalysis',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['The unconscious is structured like a language; mirror stage; the Real, Symbolic, Imaginary'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.2, reality_mysticism: -0.3, individual_collective: -0.2, freedom_coercion: 0.3, value_nihilism: 0.1, market_planning: -0.2, beauty_chaos: 0.4, good_evil: 0.1 }
  },
  {
    id: 'edith_stein',
    name: 'Edith Stein',
    ...
    latitude: 51.1079,
    longitude: 17.0385,
    school_of_thought: 'Phenomenology / Thomism',
    school: 'Phenomenology',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Empathy as philosophical concept; phenomenology of the person; synthesis with Thomism'],
    historical_weight: 0.65,
    battles: { reason_faith: -0.2, reality_mysticism: -0.3, individual_collective: 0.3, freedom_coercion: 0.5, value_nihilism: 0.6, market_planning: 0.0, beauty_chaos: 0.5, good_evil: 0.7 }
  },
  ...
  // POLITICAL PHILOSOPHY (5)
  {
    ...
    latitude: 39.7667,
    longitude: 8.8167,
    school_of_thought: 'Marxism / Cultural Hegemony',
    school: 'Marxist',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Cultural hegemony; organic intellectuals; war of position vs. war of maneuver; Prison Notebooks'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.4, reality_mysticism: 0.5, individual_collective: -0.6, freedom_coercion: 0.2, value_nihilism: 0.3, market_planning: -0.7, beauty_chaos: 0.4, good_evil: 0.3 }
  },
  {
    id: 'rosa_luxemburg',
    name: 'Rosa Luxemburg',
    ...
    latitude: 50.7167,
    longitude: 23.2500,
    school_of_thought: 'Revolutionary Socialism',
    school: 'Marxist',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Spontaneous revolution; critique of nationalism; democracy within socialism; anti-imperialism'],
    historical_weight: 0.75,
    battles: { reason_faith: 0.4, reality_mysticism: 0.5, individual_collective: -0.7, freedom_coercion: 0.3, value_nihilism: 0.4, market_planning: -0.8, beauty_chaos: 0.4, good_evil: 0.4 }
  },
  {
    id: 'isaiah_berlin',
    name: 'Isaiah Berlin',
    ...
    dates: '1909–1997',
    birth_city: 'Riga',
    birth_country_modern: 'Latvia',
    latitude: 56.9496,
    longitude: 24.1052,
    school_of_thought: 'Liberal Pluralism',
    school: 'Liberal',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Negative vs. positive liberty; value pluralism; hedgehog vs. fox; history of ideas'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.6, reality_mysticism: 0.7, individual_collective: 0.6, freedom_coercion: 0.8, value_nihilism: 0.5, market_planning: 0.4, beauty_chaos: 0.5, good_evil: 0.5 }
  },
  {
    id: 'george_orwell',
    name: 'George Orwell',
    ...
    latitude: 26.6500,
    longitude: 84.9167,
    school_of_thought: 'Democratic Socialism / Anti-Totalitarianism',
    school: 'Anti-Totalitarian',
    tradition: 'western',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Critique of totalitarianism; Newspeak; doublethink; language and thought; Animal Farm; 1984'],
    historical_weight: 0.95,
    battles: { reason_faith: 0.7, reality_mysticism: 0.8, individual_collective: 0.5, freedom_coercion: 0.9, value_nihilism: 0.6, market_planning: 0.0, beauty_chaos: 0.6, good_evil: 0.7 }
  },
  {
    ...
    latitude: 43.9131,
    longitude: 42.7208,
    school_of_thought: 'Anti-Totalitarianism / Christian Conservatism',
    school: 'Anti-Totalitarian',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Gulag Archipelago; critique of Soviet terror; individual conscience; moral recovery'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.3, reality_mysticism: 0.6, individual_collective: 0.6, freedom_coercion: 0.8, value_nihilism: 0.7, market_planning: 0.3, beauty_chaos: 0.6, good_evil: 0.8 }
  },
  ...
  // ANALYTIC & ETHICS (2)
  {
    ...
    latitude: 52.6638,
    longitude: -8.6267,
    school_of_thought: 'Analytic Philosophy / Virtue Ethics',
    school: 'Virtue Ethics',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Modern moral philosophy critique; intention; action theory; revival of virtue ethics'],
    historical_weight: 0.75,
    battles: { reason_faith: 0.5, reality_mysticism: 0.6, individual_collective: 0.4, freedom_coercion: 0.5, value_nihilism: 0.7, market_planning: 0.2, beauty_chaos: 0.4, good_evil: 0.7 }
  },
  {
    id: 'philippa_foot',
    name: 'Philippa Foot',
    ...
    death_year: 2010,
    dates: '1920–2010',
    birth_city: 'Owston Ferry',
    birth_country_modern: 'United Kingdom',
    latitude: 53.4667,
    longitude: -0.7833,
    school_of_thought: 'Virtue Ethics / Moral Philosophy',
    school: 'Virtue Ethics',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Trolley problem; natural goodness; virtue ethics revival; moral realism'],
    historical_weight: 0.7,
    battles: { reason_faith: 0.6, reality_mysticism: 0.7, individual_collective: 0.4, freedom_coercion: 0.5, value_nihilism: 0.7, market_planning: 0.2, beauty_chaos: 0.4, good_evil: 0.7 }
  },
  ...
  // FEMINIST & SOCIAL (2)
  {
    ...
    latitude: 51.5074,
    longitude: -0.1278,
    school_of_thought: 'Liberalism / Feminism',
    school: 'Feminist',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Women\'s rights; co-author with J.S. Mill; marriage equality; enfranchisement'],
    historical_weight: 0.7,
    battles: { reason_faith: 0.6, reality_mysticism: 0.7, individual_collective: 0.5, freedom_coercion: 0.8, value_nihilism: 0.6, market_planning: 0.3, beauty_chaos: 0.4, good_evil: 0.6 }
  },
  {
    id: 'simone_weil',
    name: 'Simone Weil',
    ...
    latitude: 48.8566,
    longitude: 2.3522,
    school_of_thought: 'Mysticism / Political Philosophy',
    school: 'Mystical',
    tradition: 'western',
    stance: 'anti',
    is_champion: false,
    key_ideas: ['Attention as spiritual practice; gravity and grace; decreation; worker solidarity'],
    historical_weight: 0.75,
    battles: { reason_faith: 0.2, reality_mysticism: -0.4, individual_collective: -0.2, freedom_coercion: 0.5, value_nihilism: 0.5, market_planning: -0.3, beauty_chaos: 0.6, good_evil: 0.6 }
  },

  // PSYCHOLOGY & EDUCATION (3)
  {
    id: 'viktor_frankl',
    name: 'Viktor Frankl',
    birth_year: 1905,
    ...
    latitude: 48.2082,
    longitude: 16.3738,
    school_of_thought: 'Logotherapy / Existential Psychology',
    school: 'Logotherapy',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Man\'s Search for Meaning; will to meaning; logotherapy; freedom to choose attitude'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.5, reality_mysticism: 0.6, individual_collective: 0.7, freedom_coercion: 0.8, value_nihilism: 0.8, market_planning: 0.2, beauty_chaos: 0.5, good_evil: 0.7 }
  },
  {
    id: 'maria_montessori',
    ...
    death_year: 1952,
    dates: '1870–1952',
    birth_city: 'Chiaravalle',
    birth_country_modern: 'Italy',
    latitude: 43.6000,
    longitude: 13.3333,
    school_of_thought: 'Educational Philosophy',
    school: 'Education',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Child-centered education; prepared environment; auto-education; sensitive periods'],
    historical_weight: 0.8,
    battles: { reason_faith: 0.6, reality_mysticism: 0.7, individual_collective: 0.6, freedom_coercion: 0.7, value_nihilism: 0.7, market_planning: 0.3, beauty_chaos: 0.6, good_evil: 0.6 }
  },
  {
    id: 'daniel_kahneman',
    ...
    latitude: 32.0853,
    longitude: 34.7818,
    school_of_thought: 'Behavioral Economics / Cognitive Psychology',
    school: 'Psychology',
    tradition: 'western',
    stance: 'pro',
    is_champion: false,
    key_ideas: ['Thinking Fast and Slow; cognitive biases; prospect theory; bounded rationality'],
    historical_weight: 0.85,
    battles: { reason_faith: 0.7, reality_mysticism: 0.8, individual_collective: 0.4, freedom_coercion: 0.5, value_nihilism: 0.6, market_planning: 0.2, beauty_chaos: 0.4, good_evil: 0.5 }
  },
  ...
  // SCIENCE & PHYSICS (1)
  {
    ...
    latitude: 48.4011,
    longitude: 9.9876,
    school_of_thought: 'Physics / Philosophy of Science',
    school: 'Physics/Scientist',
    tradition: 'western',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Relativity; E=mc²; unified field theory; determinism vs. quantum mechanics; pacifism'],
    historical_weight: 1.0,
    battles: { reason_faith: 0.9, reality_mysticism: 0.95, individual_collective: 0.5, freedom_coercion: 0.6, value_nihilism: 0.6, market_planning: 0.0, beauty_chaos: 0.8, good_evil: 0.5 }
  },
  ...
  // CONTEMPORARY THINKERS (2)
  {
    ...
    latitude: 45.5017,
    longitude: -73.5673,
    school_of_thought: 'Cognitive Science / Enlightenment Rationalism',
    school: 'Naturalist (Contemporary)',
    tradition: 'western',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Language instinct; evolutionary psychology; Enlightenment Now; decline of violence; rational optimism'],
    historical_weight: 0.85,
    // Steven Pinker: Canadian-American cognitive psychologist; Harvard professor.
    // Champion of Enlightenment values: reason, science, humanism, progress.
    // "The Better Angels of Our Nature" - violence has declined historically.
    // "Enlightenment Now" - reason and science produce human flourishing.
    // High reason (+0.85): science and data should guide beliefs and policy.
    // High reality (+0.9): naturalist; mind is what brain does; no mysticism.
    // Moderate individual (+0.6): liberal; values individual rights within society.
    // High freedom (+0.7): free speech advocate; critic of both left and right censorship.
    // High value (+0.8): objective human flourishing is measurable and improvable.
    battles: { reason_faith: 0.85, reality_mysticism: 0.9, individual_collective: 0.6, freedom_coercion: 0.7, value_nihilism: 0.8, market_planning: 0.4, beauty_chaos: 0.6, good_evil: 0.7 }
  },
  {
    ...
    latitude: 51.8500,
    longitude: -1.3500,
    school_of_thought: 'Liberal Conservatism / Anti-Totalitarianism',
    school: 'Anti-Totalitarian',
    tradition: 'western',
    stance: 'pro',
    is_champion: true,
    key_ideas: ['Democracy as worst system except all others; resistance to tyranny; individual liberty; Western civilization'],
    historical_weight: 1.0,
    // Winston Churchill: British statesman; wartime Prime Minister; Nobel Literature.
    // Champion of Western civilization and individual liberty against totalitarianism.
    // "We shall fight on the beaches" - defiance against Nazi tyranny.
    // "Democracy is the worst form of government, except for all the others."
    // Moderate reason (+0.6): practical wisdom over abstract theory.
    // High reality (+0.8): faced reality of Nazi threat when others appeased.
    // Strong individual (+0.7): individual liberty and rights; anti-collectivism.
